...
load("simulated_TS_CORR2_2021.2.RData")
simulations_all2 <- simulations_all
load("simulated_TS_CORR1_2021.2.RData")

#### run naive model ####

corr1_naive_nimble <- run_naive_nimble_model(simulations_all)

saveRDS(corr1_naive_nimble, file="Results/corr1_naive_nimble_results_2021.rds")

corr2_naive_nimble <- run_naive_nimble_model(simulations_all2)

saveRDS(corr2_naive_nimble, file="Results/corr2_naive_nimble_results_2021.rds")

corr3_naive_nimble <- run_naive_nimble_model(simulations_all3)

saveRDS(corr3_naive_nimble, file="Results/corr3_naive_nimble_results_2021.rds")
...
saveRDS(corr1_inla, file="Results/corr1_inla_results_2021.rds")

corr2_inla <- run_inla_model_parallel(simulations_all2)

saveRDS(corr2_inla, file="Results/corr2_inla_results_2021.rds")

corr3_inla <- run_inla_model_parallel(simulations_all3)

saveRDS(corr3_inla, file="Results/corr3_inla_results_2021.rds")
