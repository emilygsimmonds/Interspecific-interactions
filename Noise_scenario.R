...
saveRDS(noise1_naive_nimble, file="Results/Noise1_naive_nimble_results.rds")

noise2_naive_nimble <- run_naive_nimble_model(simulations_all2)

saveRDS(noise2_naive_nimble, file="Results/Noise2_naive_nimble_results.rds")
...
saveRDS(noise1_inla, file="Noise1_inla_results.rds")

noise2_inla <- run_inla_model_parallel(simulations_all2)

saveRDS(noise2_inla, file="Noise2_inla_results.rds")
